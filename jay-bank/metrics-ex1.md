bankAccountApp.Person 23 1 0 0 39 79 0 0 21 0,7626 325 0,8889 0 0,0000 0,3565 0 0 12,7391
LOC (Lines of Code)
325
NOM (Number of Methods)
21

Short Responsability
Represent the object with all info on the person holding an account. 
...
Short Responsability
Represent the object with all info on a account held by a person.
...
~ public String toString(): 1
~ public void depositMoney(double depositAmount): 2 (CC)
...
~ public boolean withdrawMoney(double withdrawAmount): 5 (CC)
...
Short Responsability
Controller with all the logic of the program.
